...
const report = `# Phase 7: Security Red-Team Report
...
fs.writeFileSync(path.join(dir, 'PHASE_7_SECURITY_REDTEAM.md'), report);
console.log('Security red-team testing complete.');
